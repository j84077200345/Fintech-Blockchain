$(document).ready(function(){
    document.getElementById('address').innerHTML = '以太坊地址 : ' + localStorage.getItem('cus_address');
    document.getElementById("ethereum_address").value = localStorage.getItem('cus_address');
});
...
function compressLZUTF8() {
	$.post("/compress-lzutf8", {json: jsonString}, function(data,status){
		...
		userkey = CryptoJS.enc.Utf8.parse(userkey)
		console.log(userkey);
